    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://code-with-mostafa.sentry.io/issues/?project=4509580521897984">Issues Page</a>.
